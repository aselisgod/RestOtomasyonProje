...
namespace RestoranDemo
{
    public partial class frmMasa : Form
    {
        ...
        private void btnMasa3_Click_1(object sender, EventArgs e)
        {
            frmSiparis frm = new frmSiparis();
        ...
        private void btnMasa4_Click_1(object sender, EventArgs e)
        {
            frmSiparis frm = new frmSiparis();
        ...
        private void btnMasa5_Click_1(object sender, EventArgs e)
        {
            frmSiparis frm = new frmSiparis();
        ...
        private void btnMasa6_Click_1(object sender, EventArgs e)
        {
            frmSiparis frm = new frmSiparis();
        ...
        private void btnMasa7_Click_1(object sender, EventArgs e)
        {
            frmSiparis frm = new frmSiparis();
        ...
        private void btnMasa8_Click_1(object sender, EventArgs e)
        {
            frmSiparis frm = new frmSiparis();
        ...
        private void btnMasa10_Click_1(object sender, EventArgs e)
        {
            frmSiparis frm = new frmSiparis();
                ...
                foreach (Control item in this.Controls)
                {
                    if (item is Button)
                    {
                        ...
                        else if (item.Name == "btnMasa" + dr["ID"].ToString() && dr["DURUM"].ToString() == "2")
                        {
                            ...
                            if (DateTime.TryParse(ms.SessionSum(2, dr["ID"].ToString()), out dt1) && DateTime.TryParse(DateTime.Now.ToShortTimeString(), out dt2))
                            {
                                DateTime t1 = dt1.AddMinutes(dt1.TimeOfDay.TotalMinutes);
                                DateTime t2 = dt2.AddMinutes(dt2.TimeOfDay.TotalMinutes);
                            ...
                            {
                                // Geçerli bir tarih/zaman biçimi sağlanamadığında yapılması gereken işlemler
                                // Örneğin, hata durumunu işleyebilir veya varsayılan değerleri atayabilirsiniz.
                            }
                        }
